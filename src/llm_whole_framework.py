...
if __name__ == "__main__":
    ...
    parser.add_argument("--image", type=str, required=True, help="输入显微图像")
    parser.add_argument(
        "--api_key",
        type=str,
        default=os.environ.get("DEEPSEEK_API_KEY"),
        help="DeepSeek API Key；建议通过 DEEPSEEK_API_KEY 环境变量提供",
    )
    parser.add_argument("--save_dir", default='./saved_llm_output', help="报告与文件保存目录")
    ...
    if not args.api_key:
        parser.error("请通过 DEEPSEEK_API_KEY 环境变量或 --api_key 提供 API Key")
